...
public class ChatGui : MonoBehaviour, IChatClientListener
{
	...
	public void Connect()
	{
        ...
        #endif
        this.chatClient.AuthValues = new AuthenticationValues(this.UserNameV2);
		this.chatClient.ConnectUsingSettings(this.chatAppSettings);

		this.ChannelToggleToInstantiate.gameObject.SetActive(false);
		Debug.Log("Connecting as: " + this.UserNameV2);
    ...
    private void OnGetUsernameResult(GetAccountInfoResult result)
    {
        ...
        this.UserNameV2 = result.AccountInfo.TitleInfo.DisplayName;
        Debug.Log("DISPLAY NAME V2 = " + this.UserNameV2);
    }

    private void OnGetUsernameError(PlayFabError error)
    {
        
        Debug.Log("SPNAME ERROR");
    }
	...
	public void OnConnected()
	{
	    ...
	    this.UserIdText.text = "Connected as "+ this.UserNameV2;
		...
		if (this.FriendsList!=null  && this.FriendsList.Length>0)
		{
			...
			{
				if (this.FriendListUiItemtoInstantiate != null && _friend!= this.UserNameV2)
				{
